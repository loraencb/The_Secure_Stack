...
def get_lab_definition(lab_id: str):
    ...
    return {
        ...
        "pre_lab_context": lab.get("pre_lab_context"),
        "environment_overview": lab.get("environment_overview"),
        "reflection_prompt": lab.get("reflection_prompt"),
        "lab_takeaways": lab.get("lab_takeaways", []),
